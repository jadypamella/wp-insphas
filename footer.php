			...
			<div class="col-lg-4 mb-5 mb-lg-0">
				<div class="row mb-5">
					<div class="col-12">
						...
						<p>O Insphas sobrevive de doações da comunidade. Não apenas de dinheiro, mas também de amor e de carinho. Faça a diferença você também!<br/><a href="<?php echo get_contacts('email_url'); ?>" title="Envie um e-mail para contato@insphas.com.br">Seja Voluntário!</a></p>
					</div>
				</div>
			...
			<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<p>Falar com a gente é mais fácil do que você imagina!</p>
